...
CONFIG_NAME="chesspuzzle_mdp_trainer.yaml"
...
EXPERIMENT_NAME="EXP_800_RandomOppo_SingleGPU_${MODEL_TAG}_turn${MAX_STEPS}_${DATA_TAG}_${TIME_TAG}"
...
python -m src.train_chess \
    ...
    actor_rollout_ref.rollout.multi_turn.envs.env_config.prompt_set="tasks.classic_games.chess.prompt.FEN_DIRECT_PROMPT_SET" \
