...
AGENT_TYPE="NLTS_BFS_N4H3"    # MDP, LPM
...
EXPERIMENT_NAME="EXP_800_N4H3_EndInvalidAction_RandomOppo_NoIncludeSimulation_LR1e-6_${AGENT_TYPE}_${MODEL_TAG}_turn${MAX_STEPS}_${DATA_TAG}_${TIME_TAG}"
