...
EXPERIMENT_NAME="EXP_800_N3H1_RuleOppo_SingleGPU_LR1e-6_KL002_NewTrial_${AGENT_TYPE}_${MODEL_TAG}_turn${MAX_STEPS}_${DATA_TAG}_${TIME_TAG}"
...
python -m src.train_chess \
    ...
    actor_rollout_ref.rollout.multi_turn.post_process.sft.sft_dataset_type="supervised-kd" \
