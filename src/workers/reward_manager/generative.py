...
class GenerativeRewardManager:
    ...
    def __call__(self, data: DataProto, return_dict=False):
        ...
        for i in tqdm(range(len(data)), desc="LLM Judging"):
            ...
            ground_truth = data_item.non_tensor_batch['golden_answers']
            # assert len(data_item.non_tensor_batch['golden_answers'])==1, print(f"multiple groundtruth {data_item.non_tensor_batch['golden_answers']}")
            ...
            score = self.compute_score(
                ...
                model_config=None,      # let the compute_score fn use its local config
                return_dict=True,
